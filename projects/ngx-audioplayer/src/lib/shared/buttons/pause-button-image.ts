...
@Component({
    ...
    >
        ...
        <g>
            <path
                style="fill:#4D4D4D;"
                d="M256,512c-68.38,0-132.667-26.628-181.02-74.981C26.628,388.667,0,324.381,0,256
		...
		S126.089,491.602,256,491.602S491.602,385.911,491.602,256S385.911,20.398,256,20.398z"
            ...
            <path
                style="fill:#4D4D4D;"
                d="M230.502,401.828h-62.215c-5.633,0-10.199-4.567-10.199-10.199V120.371
		...
		C240.701,397.262,236.135,401.828,230.502,401.828z M178.486,381.43h41.817V130.57h-41.817V381.43z"
            ...
            <path
                style="fill:#4D4D4D;"
                d="M343.713,401.828h-62.215c-5.633,0-10.199-4.567-10.199-10.199V120.371
		c0-5.632,4.566-10.199,10.199-10.199h62.215c5.633,0,10.199,4.567,10.199,10.199v271.258
		C353.912,397.262,349.346,401.828,343.713,401.828z M291.697,381.43h41.817V130.57h-41.817V381.43z"
            />
            <path
                style="fill:#4D4D4D;"
                d="M256,473.243c-5.633,0-10.199-4.567-10.199-10.199c0-5.632,4.566-10.199,10.199-10.199
		...
		C369.016,450.471,314.287,473.243,256,473.243z"
            ...
            <path
                style="fill:#4D4D4D;"
                d="M430.397,377.824c-1.885,0-3.792-0.522-5.496-1.615c-4.742-3.04-6.12-9.35-3.079-14.091
...
export class PauseButtonImageComponent implements OnInit {
    constructor() {}
